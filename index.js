...
displayCard.forEach((card) => {
	card.addEventListener("click", () => {
		const frontCard = document.querySelector(".arnaud");
		...
		if (window.matchMedia("(min-width: 400px)").matches) {
			...
			const cardBackMobile = document.querySelector(".cardBack");
			...
			function createCard(people) {
				...
				const cardBackMobile = document.createElement("cardBack");
				cardBackMobile.classList.add("cardBack");
				cardBackMobile.classList.add("cardBackMobile");
				cardBackMobile.style.width = "80%";
				...
				cardBackMobile.append(cardTitle);
				cardBackMobile.append(cardBoot);
				cardBackMobile.append(cardImg);
